...
//  Compiler....: любой
//
//  Description.: Макросы для работы с битами, пинами и виртуальными портами 
//
//  Data........: 24.05.2013 Создан
//  Data........: 16.05.2013 Добавил макрос PM_TestLevPin() зависимый от активного уровня
//
//***************************************************************************
...
/*________макросы для работы с портами. не зависят от активных уровней выводов _______*/

/*_________________________________ запись в порт ____________________________________*/
...
/*___________________________ установка направления пинов _______________________________*/
...
/*_____________________________ чтение порта ____________________________________________*/
...
/*_______________макросы для портов. зависят от заданных активных уровней пинов порта___________ */
